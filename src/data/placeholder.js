...
export const menuItems = [
  { id: 1, name: 'Spicy Chicken Combo', price: 12.90, category: 'Combo', img: '🍗', stock: 48 },
  { id: 2, name: 'Cheese Wedges', price: 5.50, category: 'Sides', img: '🧀', stock: 82 },
  { id: 3, name: 'Coleslaw (Regular)', price: 3.00, category: 'Sides', img: '🥗', stock: 60 },
  { id: 4, name: 'Original Fried Chicken', price: 9.90, category: 'Chicken', img: '🍗', stock: 35 },
  { id: 5, name: 'Crispy Chicken Burger', price: 11.50, category: 'Burger', img: '🍔', stock: 27 },
  { id: 6, name: 'Zinger Tower', price: 13.90, category: 'Burger', img: '🍔', stock: 19 },
  { id: 7, name: 'Iced Milo', price: 4.00, category: 'Drinks', img: '🥤', stock: 90 },
  { id: 8, name: 'Mineral Water', price: 1.50, category: 'Drinks', img: '💧', stock: 120 },
  { id: 9, name: 'French Fries (L)', price: 4.50, category: 'Sides', img: '🍟', stock: 55 },
  { id: 10, name: 'Whipped Potato', price: 3.50, category: 'Sides', img: '🥔', stock: 40 },
];
...
export const engineeredMenu = [
  { id: 1, name: 'Spicy Chicken Combo', category: 'Combo', price: 12.90, cost: 4.20, sold: 78, rating: 4.8, active: true },
  { id: 2, name: 'Original Fried Chicken', category: 'Chicken', price: 9.90, cost: 3.50, sold: 95, rating: 4.6, active: true },
  { id: 3, name: 'Crispy Chicken Burger', category: 'Burger', price: 11.50, cost: 3.80, sold: 52, rating: 4.4, active: true },
  { id: 4, name: 'Zinger Tower', category: 'Burger', price: 13.90, cost: 5.00, sold: 31, rating: 4.7, active: true },
  { id: 5, name: 'Cheese Wedges', category: 'Sides', price: 5.50, cost: 1.20, sold: 120, rating: 4.5, active: true },
  { id: 6, name: 'French Fries (L)', category: 'Sides', price: 4.50, cost: 0.90, sold: 88, rating: 4.3, active: true },
  { id: 7, name: 'Whipped Potato', category: 'Sides', price: 3.50, cost: 0.70, sold: 44, rating: 4.1, active: false },
  { id: 8, name: 'Iced Milo', category: 'Drinks', price: 4.00, cost: 0.80, sold: 102, rating: 4.4, active: true },
];

// ── STAFF & PAYROLL ────────────────────────────────────────────────────────────
// Task types with base pay per unit
